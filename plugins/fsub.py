...
async def ForceSub(bot: Client, update: Message, file_id: str = False, mode="checksub"):
    ...
    try:
        ...
        text="""**Fɪʀsᴛ ᴄʟɪᴄᴋ ᴏɴ 🍷 Rᴇǫᴜᴇꜱᴛ Tᴏ Jᴏɪɴ Cʜᴀɴɴᴇʟ 🍷 ʙᴜᴛᴛᴏɴ .\nNᴏᴡ Gᴏ Bᴀᴄᴋ Tᴏ Gʀᴏᴜᴘ Aɴᴅ Asᴋ Aɴʏ Mᴏᴠɪᴇs 🥵 \n\n🍷Rᴇǫᴜᴇꜱᴛ Tᴏ Jᴏɪɴ Cʜᴀɴɴᴇʟ🍷 എന്ന ബട്ടണിൽ ക്ലിക്ക് ചെയ്ത് റിക്വസ്റ്റ് കൊടുക്കുക, \nശേഷം ഗ്രൂപ്പിൽ പോയ്‌ വേണ്ട മൂവീസ് അടുത്തോ 🌹🤗**"""
